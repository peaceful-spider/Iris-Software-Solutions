  ...
  useEffect(() => {
    ...
    if (oldWebsiteBtn) {
      oldWebsiteBtn.addEventListener('click', (e) => {
        e.preventDefault();
         window.location.href = "https://iris-three-kappa.vercel.app/"; // Uncomment for production
      });
    }
    ...
    return () => {
      ...
      if (contactForm) contactForm.removeEventListener('submit', () => {});
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl p-8 card-shadow border border-gray-100">
              <div className="inline-block -mb-28 px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm font-medium">
                Under Construction
              </div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Our new website is coming soon. In the meantime, feel free to reach out with any questions.
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-8 rounded-3xl shadow-lg border border-gray-100 floating">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="ml-3 text-xl font-semibold text-gray-900">Get in Touch</h3>
                  </div>
                  <div className="space-y-6 mb-6">
                    <div className="flex items-start">
                      <div className="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">info@iriseducation.com</p>
                        <p className="text-sm text-gray-600">support@iriseducation.com</p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center mt-1 mr-3 flex-shrink-0">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Suite 400, New York, NY 10001</p>
                      </div>
                    </div>
                  </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="relative bg-white rounded-lg p-8 max-w-md w-full mx-4">
            ...
            <h3 className="text-xl font-bold text-center text-gray-900 mb-2">Message Sent Successfully!</h3>
