      ...
      <nav className="py-6 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div>
            <Link
              href="/"
              className="bg-white border border-gray-300 text-gray-700 px-5 py-2 rounded-md font-medium hover:bg-gray-50 transition-colors mr-2"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              href="#"
              id="oldWebsiteBtn"
              className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-5 py-2 rounded-md font-medium hover:opacity-90 transition-colors"
            >
              Visit Old Website
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto w-full text-center">
          <div className="bg-white rounded-2xl p-8 card-shadow border border-gray-100">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Welcome to <span className="gradient-text">Iris Education</span>
            </h1>
            <p className="text-lg text-gray-600 mb-6">
              Our new platform is coming soon. Sign up to be notified when we launch!
            </p>
            <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
              ...
              <button
                type="submit"
                className="w-full gradient-bg text-white px-6 py-3 rounded-md font-medium hover:opacity-90 transition-opacity flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-500">
              © 2023 Iris Education & Training. All rights reserved.
            </p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="relative bg-white rounded-lg p-8 max-w-md w-full mx-4">
            ...
            <h3 className="text-xl font-bold text-center text-gray-900 mb-2">Thank You!</h3>
            <p className="text-center text-gray-600 mb-6">
              You’ve been added to our notification list. We’ll keep you updated!
            </p>
            <button
